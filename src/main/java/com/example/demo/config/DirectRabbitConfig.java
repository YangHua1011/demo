...
public class DirectRabbitConfig {
    ...
    //Direct交换机 起名：TestDirectExchangeMandatory
    @Bean
    ...
    Binding bindingDelayDirect() {
        return BindingBuilder.bind(delayDirectQueue()).to(TestDirectExchange()).with("DelayDirectRouting");
    }
    ...
    public  boolean send(Map<String,Object> map){
        ...
        rabbitTemplate.convertAndSend("TestDirectExchange", "DelayDirectRouting", map,correlationData);
        return false;
    };
